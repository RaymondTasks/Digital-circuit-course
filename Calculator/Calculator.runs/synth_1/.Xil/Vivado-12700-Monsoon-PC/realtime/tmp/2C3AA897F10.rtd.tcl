...
set genomeRtd $env(RT_TMP)/2C3AA897F10.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Execute__GB2}]"
...
set genomeName [subst -nocommands -novariables {Execute__GB2}]
