...
set genomeRtd $env(RT_TMP)/2C39EEB5400.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Stack__GB2}]"
...
set genomeName [subst -nocommands -novariables {Stack__GB2}]
