...
set genomeRtd $env(RT_TMP)/2C39BEF0C40.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Execute__GB4}]"
puts "this genome's rtd file is $genomeRtd"
source $::env(HRT_TCL_PATH)/rtSynthPrep.tcl
source $::env(RT_TMP)/parameters.tcl
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList D:/Codes/Digital-circuit-course/Calculator/Calculator.runs/synth_1/.Xil/Vivado-12700-Monsoon-PC/realtime/tmp/parallel_timing.xdc; 
set genomeName [subst -nocommands -novariables {Execute__GB4}]
