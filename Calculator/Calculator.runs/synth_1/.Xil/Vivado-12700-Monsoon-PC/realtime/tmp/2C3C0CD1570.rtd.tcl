...
set genomeRtd $env(RT_TMP)/2C3C0CD1570.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {top_GT0__15}]"
...
set genomeName [subst -nocommands -novariables {top_GT0__15}]
