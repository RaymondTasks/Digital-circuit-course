...
set genomeRtd $env(RT_TMP)/2C3A99EE4E0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {datapath__93__GD}]"
...
set genomeName [subst -nocommands -novariables {datapath__93__GD}]
