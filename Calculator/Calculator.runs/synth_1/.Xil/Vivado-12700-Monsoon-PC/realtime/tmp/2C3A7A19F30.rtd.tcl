...
set genomeRtd $env(RT_TMP)/2C3A7A19F30.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {Execute__GB1}]"
...
set genomeName [subst -nocommands -novariables {Execute__GB1}]
